...
import { buildRoleConfig, ROLE_DEFINITIONS, ROLE_PRESENTATION } from "@/lib/roles";
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <header className="relative px-6 pt-12 pb-2 md:px-10">
        <div className="mx-auto flex w-full max-w-5xl flex-col-reverse items-start gap-6 md:flex-row md:items-center">
          <div className="flex-1">
            ...
            <p className="mt-4 max-w-lg text-base text-[var(--parchment-dim)]">
              Summon a secret council, share the seal of entry, and let every
              knight join from their own device for a private role reveal. No
              scrolls, no oaths — just deception.
            </p>
          </div>
          <div className="relative h-32 w-32 shrink-0 self-center md:h-44 md:w-44">
            <Image
              src={UI_ASSETS.crest}
              alt=""
              fill
              ...
              className="object-contain drop-shadow-[0_0_28px_rgba(201,168,76,0.28)]"
            />
          </div>
        </div>
        <div className="mx-auto mt-6 h-px w-full max-w-5xl bg-gradient-to-r from-transparent via-[var(--gold-dim)] to-transparent opacity-40" />
      </header>
      ...
      <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col gap-6 px-6 py-8 md:flex-row md:items-start md:gap-8 md:px-10">
            ...
            <div className="flex flex-wrap gap-2">
              {(
                ...
                <TogglePill
                  ...
                  active={options[key]}
                  label={label}
                  iconSrc={ROLE_PRESENTATION[key].iconSrc}
                  onClick={() =>
        ...
        <div className="flex w-full flex-col gap-5 md:w-[300px]">
          ...
          <Card variant="parchment" className="space-y-3">
            <h3 className="font-display text-base font-semibold text-[var(--foreground)]">
              The Ancient Rite
            </h3>
            <ul className="space-y-1.5 text-sm text-[var(--parchment-dim)]">
              <li className="flex items-start gap-2">
                ...
                Private role reveal on your own device
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[var(--gold-dim)] mt-0.5">✦</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-[var(--gold-dim)] mt-0.5">✦</span>
                Play together from any device, anywhere
              </li>
            </ul>
          </Card>
        </div>
